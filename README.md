# 🎓 SMART LECTURE AI - Ứng dụng Học tập Thông minh
...
| next-intl | Đa ngôn ngữ (Việt/Anh) |
| Lucide React | Icons |
...
### Bước 1: Tải về
```bash
git clone https://github.com/nielday/ung-dung-hoc-tap-thong-minh-AI.git
cd hang
```
...
> Smart Lecture AI - Học tập thông minh với AI! ❤️
